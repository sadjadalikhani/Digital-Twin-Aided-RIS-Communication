...
% params.active_BS = [4,6];             % Includes the numbers of the active BSs (values from 1-18 for 'O1')(check the scenario description at https://deepmimo.net/scenarios/ for the BS numbers)
params.active_BS = [15,7];
...
params.num_ant_BS = [[1, 16, 1]; [1, 4, 4]];      % Number of antenna elements for the BS arrays in the x,y,z-axes
% By default, all BSs will have the same array sizes
...
% System parameters
params.bandwidth = .2;    %.05          % The bandwidth in GHz
...
% OFDM parameters
params.num_OFDM = 512; %512                % Number of OFDM subcarriers
